...
namespace Model.MovieSearcher {
    ...
    public interface SearcherSoap {
        ...
        Model.MovieSearcher.Movie getMovieByID(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/getMovieByID", ReplyAction="*")]
        System.Threading.Tasks.Task<Model.MovieSearcher.Movie> getMovieByIDAsync(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/getAllMovies", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        Model.MovieSearcher.Movie[] getAllMovies();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/getAllMovies", ReplyAction="*")]
        System.Threading.Tasks.Task<Model.MovieSearcher.Movie[]> getAllMoviesAsync();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/getMoviesByTitle", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        Model.MovieSearcher.Movie[] getMoviesByTitle(string title);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/getMoviesByTitle", ReplyAction="*")]
        System.Threading.Tasks.Task<Model.MovieSearcher.Movie[]> getMoviesByTitleAsync(string title);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface SearcherSoapChannel : Model.MovieSearcher.SearcherSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SearcherSoapClient : System.ServiceModel.ClientBase<Model.MovieSearcher.SearcherSoap>, Model.MovieSearcher.SearcherSoap {
        ...
        public Model.MovieSearcher.Movie getMovieByID(int id) {
            return base.Channel.getMovieByID(id);
        }
        
        public System.Threading.Tasks.Task<Model.MovieSearcher.Movie> getMovieByIDAsync(int id) {
            return base.Channel.getMovieByIDAsync(id);
        }
        
        public Model.MovieSearcher.Movie[] getAllMovies() {
            return base.Channel.getAllMovies();
        }
        
        public System.Threading.Tasks.Task<Model.MovieSearcher.Movie[]> getAllMoviesAsync() {
            return base.Channel.getAllMoviesAsync();
        }
        
        public Model.MovieSearcher.Movie[] getMoviesByTitle(string title) {
            return base.Channel.getMoviesByTitle(title);
        }
        
        public System.Threading.Tasks.Task<Model.MovieSearcher.Movie[]> getMoviesByTitleAsync(string title) {
